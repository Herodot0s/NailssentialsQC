...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/.gsd-surface.json`
(sibling to `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/skills`).
...
`C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/.gsd-profile`
Skill dirs: `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/skills/gsd-*/`
Engine module: `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>

...
```bash
INIT=$(node "C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Administrator/Desktop/nailssentialsqc-system/.claude/get-shit-done/bin/gsd-tools.cjs" commit \

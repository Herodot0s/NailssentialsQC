...
const Home = () => {
  ...
  const { data: faqRes } = useQuery({
    ...
    queryFn: () =>
      getCmsContent({ type: 'faq', limit: 5, activeOnly: true }).then((r) =>
  ...
  return (
    <main
      className="flex flex-col min-h-[calc(100vh-64px)] overflow-x-hidden"
      data-testid="home-page"
    >
      <Hero
        tagline={s?.hero?.tagline}
        headline={
          s?.hero?.headline && s?.hero?.headline !== 'Elevate Your Natural Beauty'
            ? s?.hero?.headline
            : undefined
        }
        ...
        <div className="container px-6 mx-auto max-w-5xl">
          ...
          <div className="mb-20 md:mb-24">
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="text-primary font-bold tracking-[0.2em] text-[11px] uppercase">
                Our Philosophy
              </span>
            </div>
            ...
            <p className="text-muted-foreground text-base md:text-lg font-light leading-relaxed max-w-xl">
              Every detail at Nailssentials is chosen with intention, from the tools we sterilize to
              the artisans we train.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-16">
            <div className="md:col-span-2 space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Hospital-standard sterilization protocols protect every client. Your health is never
                a compromise.
              </p>
            </div>
            <div className="md:col-span-3 md:border-l md:border-primary/10 md:pl-16 space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                Our technicians are dedicated artisans of beauty. Each holds specialized
                certifications and undergoes continuous training to deliver results that exceed
                expectations.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 text-center bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 max-w-xl space-y-8">
          ...
          <Link to="/register">
            <Button
              size="lg"
              className="px-12 bg-white text-primary hover:bg-primary-light hover:text-primary shadow-premium"
            >
              {footerButtonLabel}
            </Button>
          </Link>

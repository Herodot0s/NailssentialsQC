      ...
      <CardContent className="p-0">
        ...
        <div className={cn(
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap items-center gap-2 md:gap-4">
                  <p className="utility-xs text-body/60">
                    {item.childServices.length} Components
                  </p>
                  {savings > 0 && (
          ...
          <div className={cn(
            ...
            <p className="sm:hidden utility-xs text-body/50 font-bold uppercase tracking-wider">Package Total</p>
                ...
                >
                  <div className="flex items-start gap-4 mb-5">
                    <div className={cn(
                      ...
                      isChildConfigured ? "bg-accent-green-soft text-accent-green border-accent-green/20" : "bg-surface-card text-body/60 border-hairline"
                    )}>
                      {index + 1}
                    </div>
                  <div className="space-y-1">

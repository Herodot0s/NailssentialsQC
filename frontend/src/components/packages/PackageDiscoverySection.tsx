      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div className="max-w-2xl">
            ...
            >
              Hand-picked combinations designed for complete tranquility. Our packages offer a
              seamless journey through our signature services.
            </motion.p>
          </div>
          ...
          {packages.map((_, idx) => (
            <button
              ...
              className={`h-1.5 transition-all duration-500 rounded-full ${
                idx === activeIndex ? 'w-12 bg-primary' : 'w-2 bg-border hover:bg-muted-foreground'
              }`}

      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="rounded-none border-none shadow-sm bg-white p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] uppercase font-bold tracking-[0.2em] text-muted-foreground">Top Performer</p>
        ...
        <Card className="rounded-none border-none shadow-sm bg-white p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] uppercase font-bold tracking-[0.2em] text-muted-foreground">Total Revenue</p>
              <h3 className="text-xl font-bold">₱{performanceData.reduce((acc, curr) => acc + curr.revenue, 0).toLocaleString()}</h3>
            </div>
          </div>
        </Card>
        ...
        <Card className="rounded-none border-none shadow-sm bg-white p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] uppercase font-bold tracking-[0.2em] text-muted-foreground">Total Rituals</p>
              <h3 className="text-xl font-bold">{performanceData.reduce((acc, curr) => acc + curr.serviceCount, 0)}</h3>
            </div>
          </div>
        </Card>
      </div>
          ...
          <div className="w-full">
            ...
            <div className="divide-y divide-gray-50">
              {performanceData.length === 0 ? (
                ...
                return (
                  <div key={staff.staffId} className="grid grid-cols-[1fr_120px_120px_120px_200px] gap-4 p-6 items-center hover:bg-gray-50 transition-colors">
                    ...
                    <div className="text-sm text-primary font-bold">₱{staff.commission.toLocaleString()}</div>

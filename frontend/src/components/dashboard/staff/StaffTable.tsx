        ...
        <Table>
          <TableHeader className="bg-bisque-wash/30">
            <TableRow className="hover:bg-transparent border-kiln-border">
              <TableHead className="pl-8 py-5 text-[11px] uppercase tracking-[0.2em] font-semibold text-warm-stone">Employee</TableHead>
              <TableHead className="text-[11px] uppercase tracking-[0.2em] font-semibold text-warm-stone">Role</TableHead>
              <TableHead className="text-[11px] uppercase tracking-[0.2em] font-semibold text-warm-stone">Gov ID Status</TableHead>
              <TableHead className="text-[11px] uppercase tracking-[0.2em] font-semibold text-warm-stone text-right pr-8">Status</TableHead>
            </TableRow>
          </TableHeader>
            ...
            {staffMembers.length === 0 ? (
              <TableRow>
                <TableCell colSpan={4} className="h-48 text-center">
                  <div className="flex flex-col items-center justify-center space-y-2 opacity-40">
                    ...
                    <p className="text-[11px] uppercase font-semibold tracking-widest text-warm-stone">No Artisans Recruited Yet</p>
                  </div>
                </TableCell>
              </TableRow>
              ...
              >
                <TableCell className="pl-8 py-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-warm-stone uppercase tracking-[0.1em]">{staff.email || 'No email'}</p>
                    </div>
                  </div>
                </TableCell>
                <TableCell>
                  <span className="text-[11px] uppercase font-semibold tracking-tight bg-bisque-wash/50 text-warm-stone px-2 py-0.5">{staff.role}</span>
                </TableCell>
                <TableCell>
                ...
                <TableCell className="text-right pr-8">
                  <Badge className={`rounded-md border-none text-[11px] font-semibold uppercase tracking-widest ${staff.isActive ? 'bg-forest-confirm text-white' : 'bg-bisque-wash text-warm-stone'}`}>

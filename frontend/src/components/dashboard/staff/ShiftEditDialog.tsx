         ...
         >
          ...
          `}</style>
            <div className="p-6 border-b border-[#dcdfd2]">
               <DialogHeader>
                  <DialogTitle className="font-sans text-[20px] font-bold text-[#23251d]">Edit Shift</DialogTitle>
                  <DialogDescription className="text-[#4d4f46] text-[15px]">
                     Day {(editingDay ?? 0) === 0 ? 'Sunday' : ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'][editingDay! - 1]}
                  </DialogDescription>
               </DialogHeader>
            </div>
            <form onSubmit={onSubmit} className="p-6 space-y-6">
               <div className="flex items-center justify-between">
                  <Label className="text-[12px] uppercase font-bold text-[#4d4f46] tracking-wider">Active Shift</Label>
                  <button
                     type="button"
                     role="switch"
                  ...
                  >
                     <div className={`w-4 h-4 bg-white rounded-full transition-transform duration-200 ${form.isActive ? 'translate-x-6' : 'translate-x-0'}`} />
                  </button>
               </div>
               {form.isActive && (
                  <div className="grid grid-cols-2 gap-4">
                     <div className="space-y-1.5">
                        <Label className="text-[12px] uppercase font-bold text-[#6c6e63] tracking-tight">Start Time</Label>
                        <Input
                           type="time"
                           value={form.start}
                     ...
                     <div className="space-y-1.5">
                        <Label className="text-[12px] uppercase font-bold text-[#6c6e63] tracking-tight">End Time</Label>
                        <Input
                           type="time"
                           value={form.end}

        ...
        <Card className="rounded-none border-none shadow-sm bg-white">
          <CardHeader className="border-b border-gray-50">
            <CardTitle className="font-serif text-2xl font-light italic">
              Entry <span className="not-italic">Form</span>
            </CardTitle>
            <CardDescription className="text-[9px] uppercase font-bold tracking-[0.2em]">
              Log employee advances and uniforms
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-8">
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(val: string | null) =>
                      onFormChange({ ...deductionForm, type: val || 'Cash Advance' })
                    }
                  >
                    <SelectTrigger className="rounded-none border-gray-200 h-12 bg-gray-50/30">
                      <SelectValue>{deductionForm.type || 'Cash Advance'}</SelectValue>
                    </SelectTrigger>
                    <SelectContent className="rounded-none border-none shadow-2xl">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="rounded-none border-gray-200 h-12 bg-gray-50/30"
                  />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <Button
                type="submit"
                className="w-full rounded-none h-14 uppercase tracking-[0.3em] font-bold text-xs shadow-xl shadow-primary/20"
              >
          ...
          <Card className="rounded-none border-none shadow-sm bg-primary-ultra/20">
            <CardContent className="p-8">
              <div className="space-y-12">
                ...
                <p className="text-[8px] text-muted-foreground italic pt-4">
                  Data reflects unfinalized weekly deductions for the current cycle.
                </p>
              </div>
            </CardContent>
          </Card>

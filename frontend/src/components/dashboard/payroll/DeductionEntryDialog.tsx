        ...
        <form onSubmit={onSubmit} className="p-12 space-y-8 bg-white">
           ...
           <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                 ...
                 <Input type="number" required placeholder="0.00" value={form.amount} onChange={e => onFormChange({...form, amount: e.target.value})} className="rounded-none border-gray-200 h-12" />
              </div>
           </div>
           <div className="space-y-2">
           ...
           <DialogFooter className="pt-8">
              <Button type="button" variant="ghost" className="rounded-none h-12 px-8 text-[10px] uppercase font-bold" onClick={() => onOpenChange(false)}>Cancel</Button>

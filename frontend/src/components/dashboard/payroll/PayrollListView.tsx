      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-muted-foreground uppercase tracking-widest mt-1">
            Manage weekly compensation cycles
          </p>
        </div>
        <Button
          onClick={onGenerateNext}
          className="gap-2 rounded-none px-6 uppercase text-[10px] font-bold tracking-widest h-11"
        >
        ...
        <Table>
          <TableHeader className="bg-gray-50/50">
            <TableRow className="border-none hover:bg-transparent">
              ...
              <TableHead className="text-[10px] font-bold uppercase tracking-widest py-5 text-right">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
                ...
                <TableCell colSpan={6} className="h-64 text-center">
                  <div className="flex flex-col items-center gap-2 opacity-40">
                    ...
                    <p className="text-[10px] uppercase tracking-widest">
                      Click "Generate Next Period" to start a new weekly payroll.
                    </p>
                  </div>
                </TableCell>
              </TableRow>

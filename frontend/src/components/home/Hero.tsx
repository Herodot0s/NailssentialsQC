            ...
            >
              <Link to="/booking" className="w-full sm:w-auto">
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <Button size="lg" className="w-full bg-white text-charcoal-bark hover:bg-primary-light hover:text-charcoal-bark shadow-premium h-14 px-8 rounded-xl text-xs uppercase tracking-widest font-bold">
                    {buttonLabel}
                  </Button>
                </motion.div>
              </Link>

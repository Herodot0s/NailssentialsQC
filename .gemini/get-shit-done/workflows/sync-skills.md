...
INSTALL_JS_GLOBAL="C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

...
```
Task(
  prompt="Read C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/get-shit-done/templates/VALIDATION.md`

...
```bash
INIT=$(node "C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/get-shit-done/templates/spec.md.

...
The keys live in `.claude/settings.json` (project) or `C:/Users/Administrator/Desktop/nailssentialsqc-system/.gemini/settings.json` (global) — **not** in `.planning/config.json`:
